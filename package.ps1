...
$files = @(
    ...
    'extension/conditions.js', 'extension/snapshot-cache.js',
    ...
    'tests/conditions.mjs', 'tests/cli-efficiency.mjs', 'tests/headless-browser.mjs', 'tests/efficiency-browser.mjs',
