...
$files = @(
    ...
    'extension/conditions.js', 'extension/snapshot-cache.js', 'extension/read-policy.js',
    ...
    'tests/conditions.mjs', 'tests/read-policy.mjs', 'tests/cli-efficiency.mjs', 'tests/headless-browser.mjs', 'tests/efficiency-browser.mjs',
    'tests/adaptive-read-benchmark.mjs',
